...
description: Zero-downtime pattern for breaking changes. Use when renaming DB columns, changing data types, replacing services/libraries, or modifying public APIs. Applies expand-contract to maintain backward compatibility throughout the migration.
---
icon: 🔄
